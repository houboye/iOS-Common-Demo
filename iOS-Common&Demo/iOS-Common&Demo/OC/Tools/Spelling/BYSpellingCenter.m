...
@interface BYSpellingCenter ()
- (SpellingUnit *)calcSpellingOfString: (NSString *)source;
@end


@implementation BYSpellingCenter
+ (BYSpellingCenter *)sharedCenter
{
    static BYSpellingCenter *instance = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        instance = [[BYSpellingCenter alloc]init];
    });
    return instance;
}
...
- (SpellingUnit *)calcSpellingOfString:(NSString *)source
{
    ...
    for (NSInteger i = 0; i < [source length]; i++)
    {
        ...
        NSString *pinyin = [[BYPinyinConverter sharedInstance] toPinyin:word];
